...
function visibilityControlButon(btnOpen, btnRegister){
    if (btnOpen.classList.contains('btn-active')) {
        ...
        btnRegister.style.backgroundColor = '#ee3ac1';
        btnOpen.style.backgroundColor = 'rgb(161, 159, 156)';

    } else {
        btnOpen.classList.add('btn-active');
        btnRegister.classList.remove('btn-active');
        btnRegister.style.backgroundColor = 'rgb(161, 159, 156)';
        btnOpen.style.backgroundColor = '#ee3ac1';
    }
}
